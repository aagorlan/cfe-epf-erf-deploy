...
Процедура НастроитьКомандыПриложения(Знач Приложение) Экспорт
	...
	//...
	Приложение.ДобавитьКоманду("loadcfe", "КомандаЗагрузитьРасширения", 
		"Загружает все расширения из папки, имена определяются автоматически, отдельная папка на каждое расширение");
